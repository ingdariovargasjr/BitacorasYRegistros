...
<body>
        ...
        <div class="container"><a class="navbar-brand logo" href="inicio.php?user=<?php echo $user = $_GET['user']; ?>">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item active" role="presentation"><a class="nav-link" href="registros_scia.php?user=<?php echo $user = $_GET['user']; ?>">CSIA</a></li>
    ...
    <main class="page registration-page">
        <section class="container ui align-content-sm-start">
            ...
            <br />
            <h1 class="text-info">
                <font face="Montserrat"><strong>REGISTROS DE CSIA</strong></font>
            </h1>
            <h5 class="text">
                        ...
                        <table id="example" class="table table-striped table-bordered table-responsive-sm table-hover text-center">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    href="editado_scia.php?edit=<?php echo $row['id']; ?>&user=<?php echo $user = $_GET['user']; ?>">
                                    <i class="fa fa-pencil fa-fw" aria-hidden="true"></i>Editar</a>
                                <a name="borrado" id="borrado" class="btn btn-outline-danger"
                                    href="user_delete_scia.php?borrar=<?php echo $row['id']; ?>&user=<?php echo $user = $_GET['user']; ?>">
                                    <i class="fa fa-trash-o" aria-hidden="true"></i>Borrar</a -->

                                    <a class="btn btn-outline-success" name="editado" id="editado" href="user_active_scia.php?edit=<?php echo $row['id']; ?>&user=<?php echo $user = $_GET['user']; ?>">
                                        <!--i class="fa fa-check fa-fw" aria-hidden="true"></i-->A</a>
                                    <a name="borrado" id="borrado" class="btn btn-outline-danger" href="user_delete_scia.php?borrar=<?php echo $row['id']; ?>&user=<?php echo $user = $_GET['user']; ?>">
                                        <!--i class="fa fa-times" aria-hidden="true"></i-->D</a>
                                    <a class="btn btn-md btn-outline-primary" name="editado" id="editado" href="editado_scia.php?edit=<?php echo $row['id']; ?>&user=<?php echo $user = $_GET['user']; ?>">
    ...
    <div class="buttons" align="center">
        <a class="btn btn-outline-success" href="nuevo_registro_scia.php?user=<?php echo $user = $_GET['user']; ?>">Nuevo
            Registro</a>
