...
<body>
        ...
        <div class="grid-container">
            <form>
                <div class="row" style="margin-top: 1px">
                    <div style=" width: 1990px;">
                        <table id="example"
                            class="table table-striped table-bordered table-responsive table-hover text-center">
                            <thead>
                                <tr>
    ...
    <div class="buttons" align="center">
        <a class="btn btn-outline-success"
            href="nuevo_registro_scia.php?user=<?php echo $user = $_GET['user']; ?>">Nuevo
            Registro</a>
