...
$sql2 = "INSERT INTO bitacoras (correo_electronico, username, password, area, fecha, vinculado, accion, pers_modifico) 
       VALUES ('" . $correo . "','" . $usuario . "', '" . $contraseña . "', '" . $area . "' '" . $vinculacion . "','" . $date . "','CREACIÓN', '" . $userBit . "')";
...
window.location.href = 'registros_sodasa.php';
</script>";




header("location: registros_sodasa.php?user=$userBit");