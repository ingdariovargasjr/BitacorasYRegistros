...
echo $sql = "UPDATE usuario_scia SET correo_electronico= '$correo ', username= '$usuario', password= '$contraseña', area='$area', vinculado='$vinculado' WHERE id='$edit'";
...
echo "<script>
            ...
            window.location.href='editado_scia.php?user=$user';
        </script>"; 
