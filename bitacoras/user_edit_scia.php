...
echo $edicion = "INSERT INTO bitacoras (correo_electronico, username, password, area, fecha, vinculado, accion, pers_modifico, enTabla) 
    VALUES ('" . $correo . "','" . $usuario . "', '" . $contraseña . "', '" . $area . "', '" . $vinculado . "', '" . $fecha . "','EDICIÓN', '" . $user . "', 'CSIA')";

echo $sql2 = "SELECT * FROM usuario_sica WHERE id='$edit'";
...
echo "<script>
            ...
            window.location.href='editado_scia.php?edit=$edit&user=$user';
        </script>";
...
echo $edicion = "INSERT INTO bitacoras (correo_electronico, username, password, area, fecha, vinculado, accion, pers_modifico, enTabla) 
    VALUES ('" . $correo . "','" . $usuario . "', '" . $contraseña . "', '" . $area . "', '" . $fecha . "', '" . $vinculado . "','EDICIÓN', '" . $user . "', 'CSIA')";
