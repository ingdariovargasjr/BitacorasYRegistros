                        ...
                        <table id="example"
                            ...
                            <tbody>
                                ...
                                <a name="borrado" id="borrado" class="btn btn-outline-danger"
                                    href="user_delete_multimodal.php?borrar=<?php //echo $row['id']; 
                                                                            ?>&user=<?php// echo $user = $_GET['user']; ?>">
                                    <i class="fa fa-trash-o" aria-hidden="true"></i>Borrar</a> -->

                                <a class="btn btn-outline-success" name="editado" id="editado"
                                    href="user_active_multimodal.php?edit=<?php echo $row['id']; ?>&user=<?php echo $user = $_GET['user']; ?>">
