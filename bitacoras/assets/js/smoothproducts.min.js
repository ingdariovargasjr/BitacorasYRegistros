!(function (a) {
  a.fn.extend({
    smoothproducts: function () {
      ...
      function noEmpty() {
        //this will check if the textbox is empty and not let any be blank or empty
        var empty;
        var yes;
        var no;
      }
      ...
      a(".sp-loading").hide(),
        ...
        a(document.body).on("mouseenter", ".sp-non-touch .sp-large", function (
          b
        ) {
        ...
        a(document.body).on("mouseleave", ".sp-non-touch .sp-large", function (
          b
        ) {
          a(this)
            .find(".sp-zoom")
