            ...
            <div class="container"><a class="navbar-brand logo" href="inicio.php?user=<?php echo $user = $_GET['user']; ?>">
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav">
                        <li class="nav-item" role="presentation"><a class="nav-link" href="registros.php?user=<?php echo $user = $_GET['user']; ?>">registros</a></li>
                ...
                <div class="container">
                    ...
                    <form method="post" action="user_edit.php?user=<?php echo $user = $_GET['user']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input list="encodings" name="area" id="area" class="form-control item col-sm-12 custom-select custom-select-sm" value="<?php echo $area ?>">
