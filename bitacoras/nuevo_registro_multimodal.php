        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form class="was-validate" name="multimodalForm" method="post"
                    action="get_response_registros_multimodal.php?user=<?php $user = $_GET['user']; ?>"
                    onsubmit="return validateForm()" requiered>

                    <div class="form-group">
                        <button id="opcion" type="button" class="btn btn-outline-primary btn-block"
                            onclick="disable()">Click para vincular correo</button>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="vinculado" id="vinculado" class="form-control item col-sm-12 custom-select"
                            ...
                            <select list="vinculacion" name="vinculado" id="vinculado"
                                class="form-control item col-sm-12 custom-select custom-select-md" disabled>
                                <option value="NO VINCULADO">Seleccione</option>
                    ...
                    <a class="btn btn-outline-danger btn-block"
                        href="registros_multimodal.php?user=<?php echo $user = $_GET['user']; ?>">Cancelar</a>
            </div>
...
<script>
function myFunction() {
    document.getElementById("vinculado").style.visibility = "visible";
}
</script>
...
$(document).ready(function() {
    ...
    $("#opcion").click(function() {
        $("#vinculado").prop("disabled", false);
        document.getElementById("opcion").innerHTML = "Doble click para no vincular correo";
    });

    $("#opcion").dblclick(function() {
        $("#vinculado").prop("disabled", true);
        document.getElementById("opcion").innerHTML = "Click vincular correo";
    });
