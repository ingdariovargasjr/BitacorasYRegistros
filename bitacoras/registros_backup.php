...
<body>
        ...
        <div class="container"><a class="navbar-brand logo" href="inicio.php?user=<?php echo $user = $_GET['user']; ?>">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="bitacoras.php">bitacoras</a>
                    </li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="acerca_de.php">acerca
                            de</a></li>
                </ul>
    ...
    <main class="page registration-page">
        <section class="container ui">
            ...
            <?php include "tabla_asset_registros.php"; ?>
