...
$borrar = $_GET['borrar'];
$sql_1 = "SELECT * FROM usuario_sodasa WHERE id=$borrar";
...
$backup = "SELECT * FROM usuario_sodasa WHERE id='$borrar'";
...
$eliminacion = "INSERT INTO bitacoras (correo_electronico, username, password, area, fecha, vinculado, accion, pers_modifico, enTabla) 
    VALUES ('" . $correo . "','" . $usuario . "', '" . $contraseña . "', '" . $area . "','" . $fecha . "','" . $vinculado . "','DESACTIVADO', '" . $user . "', 'SODASA')";
...
/*$sql = "DELETE FROM usuario_sodasa WHERE id='$borrar'";
...
header("location: registros_sodasa.php?user=$user");