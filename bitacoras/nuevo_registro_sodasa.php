    ...
    <main class="page registration-page">
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form name="sodasaForm" method="post" action="get_response_registros_sodasa.php?user=<?php echo $user = $_GET['user']; ?>" onsubmit="return validateForm()" requiered>
                    <div class="form-group">
                        <button type="button" class="btn btn-outline-primary btn-block" onsubmit="return myFunction()">Tengo mas de
                            un
                            dispositivo</button>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select list="encodings" name="area" id="area" class="form-control item col-sm-12 custom-select custom-select-md">
            ...
            <div class="form-group">
                ...
                <select name="vinculado" id="vinculado" class="form-control-hidden form-control item col-sm-12 custom-select">
                    </br>
                    </br>
                    <label for="vinculacion"><strong>Vinculado a:</strong></label>
                    <select list="vinculado" name="vinculado" id="vinculado" class="form-control-hidden form-group-hidden item col-sm-12 custom-select custom-select-md" readonly>
            ...
            <a class="btn btn-outline-danger btn-block" href="registros_sodasa.php?user=<?php echo $user = $_GET['user']; ?>">Cancelar</a>
            </div>
...
<script type="text/javascript">
    function validateForm() {
        ...
        window.location.href = 'registros_sodasa.php?user=<?php $user = $_GET['
    user ']; ?>';
    }
</script>
