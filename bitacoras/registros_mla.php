    ...
    <body>
        <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-white clean-navbar"
            ...
            <div class="container"><a class="navbar-brand logo"
                    href="inicio.php?user=<?php echo $user = $_GET['user']; ?>">
        ...
        <main class="page registration-page">
            <section class="container ui align-content-sm-start">
                ...
                <br />
                <h1 class="text-info">
                    <font face="Montserrat"><strong>REGISTROS DE MLA</strong></font>
                </h1>
                <h5 class="text">
                    <font face="Montserrat">Para acceder a <a href="http://webmail.alestraune.net.mx/app/">Alestra</a>,
                        es con el usuario:
                        admmultimodal@multimodallogistics.com.mx y la contraseña: lgs.ml#</font>
                </h5>
            </section>
                        ...
                        <div style=" overflow-x:auto; width: 1990px;">
                            <table id="example"
                                ...
                                <tbody>
                                    ...
                                    ?> <a class="btn btn-outline-success" name="editado" id="editado"
                                        href="user_active_mla.php?edit=<?php echo $row['id']; ?>&user=<?php echo $user = $_GET['user']; ?>">
                                        <!--i class="fa fa-check fa-fw" aria-hidden="true"></i-->A</a>
                                    <a name="borrado" id="borrado" class="btn btn-outline-danger"
                                        href="user_delete_mla.php?borrar=<?php echo $row['id']; ?>&user=<?php echo $user = $_GET['user']; ?>">
                                        <!--i class="fa fa-times" aria-hidden="true"></i-->D</a>
                                    <a class="btn btn-md btn-outline-primary" name="editado" id="editado"
                                        href="editado_mla.php?edit=<?php echo $row['id']; ?>&user=<?php echo $user = $_GET['user']; ?>">
        ...
        <div class="buttons" align="center">
            <a class="btn btn-outline-success"
                href="nuevo_registro_mla.php?user=<?php echo $user = $_GET['user']; ?>">Nuevo
                Registro</a>
