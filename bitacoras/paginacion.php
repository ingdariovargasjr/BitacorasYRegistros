        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
            ...
            <div class="container-fluid d-flex flex-column p-0">
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#"><img
                        src="assets/img/logM.png" style="width: 85px; height: 65px;"
                        alt="image" />&nbsp;<span>EMPLEADOS</span></a>
                <hr class="sidebar-divider my-0" />
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="inicio.php"><i
                                class="fas fa-tachometer-alt"></i><span>Inicio</span></a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="profile.php"><i class="fas fa-user"></i><span>Perfil</span></a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" href="empleados.php"><i
                                class="fas fa-table"></i><span>Empleados</span></a>
                    </li>
                    <li class="nav-item" role="presentation"></li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="busqueda_especifica.php"><i class="fas fa-search"></i><span>Busqueda
                                especifica</span></a>
                    </li>
                </ul>
                        ...
                        <div class="card-body">
                            ...
                            <th> <font face='Montserrat'><strong></strong></font> </th> 
                                        ...
                                        <a class="btn btn-outline-primary" name="editado" id="editado"
                                            href="editado_sodasa.php?edit=<?php echo $row['id']; ?>&user=<?php echo $user = $_GET['user']; ?>"><i
                                                class="fa fa-pencil fa-fw" aria-hidden="true"></i>Editar</a>
                                        <a name"borrado" id"borrado" class="btn btn-outline-danger"
                                            href="user_delete_sodasa.php?borrar=<?php echo $row['id']; ?>&user=<?php echo $user = $_GET['user']; ?>">
                                        ...
                                        <div class="buttons" align="center">
                                            <a class="btn btn-outline-success"
                                                href="nuevo_registro_sodasa.php?user=<?php echo $user = $_GET['user']; ?>">Nuevo
                                                Registro</a>
