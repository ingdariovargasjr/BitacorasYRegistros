    ...
    <main class="page registration-page">
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form class="was-validate" name="multimodalForm" method="post" action="get_response_registros_scia.php" onsubmit="return validateForm()" requiered>
                    <div class="form-group"><label for="correo_electronico"><strong>*Email</strong></label><input class="form-control item" type="text" name="correo_electronico" id="correo_electronico" requiered>
                    </div>
                    <div class="form-group"><label for="usuario"><strong>*Usuario</strong></label><input class="form-control item" type="text" name="usuario" id="usuario" requiered></div>
                    <div class="form-group"><label for="contraseña"><strong>*Contraseña</strong></label><input class="form-control item" type="password" name="contraseña" id="contraseña" requiered></div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="vinculado" id="vinculado" class="form-control item col-sm-12 custom-select" requiered>
                            ...
                            <label for="vinculacion"><strong>Vinculado a:</strong></label>
                            <select list="vinculacion" name="vinculado" id="vinculado" class="form-control item col-sm-12 custom-select custom-select-md">>
                    ...
                    <a class="btn btn-outline-danger btn-block" href="registros_scia.php?user=<?php echo $user = $_GET['user']; ?>">Cancelar</a>
            </div>
