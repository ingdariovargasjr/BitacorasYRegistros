...
$sql = "INSERT INTO usuario_mla (correo_electronico, username, password, area, vinculado) 
VALUES ('" . $correo . "','" . $usuario . "', '" . $contraseña . "', '" . $area . "', '" . $vinculado . "')";

$sql2 = "INSERT INTO bitacoras (correo_electronico, username, password, area, vinculado, fecha, accion, pers_modifico) 
       VALUES ('" . $correo . "','" . $usuario . "', '" . $contraseña . "', '" . $area . "', '" . $vinculado . "','" . $date . "','CREACIÓN', '" . $userBit . "')";
...
window.location.href = 'registros_mla.php';
</script>";<?php

            echo $vinculado;


            header("location: registros_mla.php?user=$userBit"); ?>