    ...
    <main class="page registration-page">
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form name="sodasaForm" method="post"
                    action="user_edit_mla.php?user=<?php echo $user = $_GET['user']; ?>&edit=<?php echo $edit = $_GET['edit']; ?>"
                ...
                if (isset($_POST['creacion'])) {
                    ...
                    $sql = "INSERT INTO bitacoras (correo_electronico, username, password, area, fecha, accion, pers_modifico, enTabla) 
