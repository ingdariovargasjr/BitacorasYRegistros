...
$edit = $_GET['edit'];
$sql = "SELECT * FROM usuario_mla WHERE id=$edit";
        ...
        <div class="container"><a class="navbar-brand logo" href="inicio.php?user=<?php echo $user = $_GET['user']; ?>">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item active" role="presentation"><a class="nav-link" href="registros_mla.php?user=<?php echo $user = $_GET['user']; ?>">MLA</a></li>
    ...
    <main class="page registration-page">
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form class="was-validate" name="multimodalForm" method="post" action="user_edit_mla.php?user=<?php echo $user ?>" onsubmit="return validateForm()" requiered>
                    <div class="form-group"><label for="correo_electronico"><strong>*Email</strong></label><input class="form-control item" type="text" name="correo_electronico" id="correo_electronico" value="<?php echo $correo ?>" requiered>
                    </div>
                    <div class="form-group"><label for="usuario"><strong>*Usuario</strong></label><input class="form-control item" type="text" name="usuario" id="usuario" value="<?php echo $usuario ?>" requiered></div>
                    <div class="form-group"><label for="contraseña"><strong>*Contraseña</strong></label><input class="form-control item" type="password" name="contraseña" id="contraseña" value="<? echo $contraseña?>" requiered></div>
                    <div class="form-group">
                        <label for="area"><strong>*Area</strong></label>
                        <select list="encodings" name="area" id="area" class="form-control item col-sm-12 custom-select custom-select-md" requiered>
                    ...
                    <div class="form-group">
                        ...
                        <select name="vinculado" id="vinculado" class="form-control item col-sm-12 custom-select" requiered>
                            </br>
                            </br>
                            <label for="vinculacion"><strong>Vinculado a:</strong></label>
                            <select list="vinculacion" name="vinculado" id="vinculado" value="<? echo $vinculado?>" class="form-control item col-sm-12 custom-select custom-select-md">>
                    ...
                    <a class="btn btn-outline-danger btn-block" href="registros_mla.php?user=<?php echo $user = $_GET['user']; ?>">Cancelar</a>
            </div>
