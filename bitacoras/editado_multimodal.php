...
$edit = $_GET['edit'];
$sql = "SELECT * FROM usuario_multimodal WHERE id=$edit";
    ...
    <main class="page registration-page">
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form class="was-validate" name="multimodalForm" method="post" action="user_edit_multimodal.php"
                    onsubmit="return validateForm()" requiered>
                    <div class="form-group">
                        <button id="opcion" type="button" class="btn btn-outline-primary btn-block"
                            onclick="disable()">Click para desvincular correo</button>
                    </div>
...
$(document).ready(function() {
    ...
    //     document.getElementById("opcion").innerHTML = "Doble click para no vincular mi correo";
    // });

    $("#opcion").click(function() {
        $("#vinculado").prop("disabled", true);
        document.getElementById("opcion").innerHTML = "DESVINCULADO";
    });
