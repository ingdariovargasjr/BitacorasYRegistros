        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form name="mutlimodalForm" method="post" onsubmit="return validateForm()" requiered
                    action="user_edit_multimodal.php?user=<?php echo $user = $_GET['user']; ?>&edit=<?php echo $edit = $_GET['edit']; ?>">
                ...
                if (isset($_POST['edicion'])) {
                    ...
                    $sql = "INSERT INTO usuario_multimodal (correo_electronico, username, password, area) 
    VALUES ('" . $correo . "','" . $usuario . "', '" . $contraseña . "', '" . $area . "');" . "CREATE TRIGGER  'after_insert_usuario' ON bitacoras
BEFORE INSERT ON usuario
FOR EACH ROW
BEGIN
INSERT INTO bitacoras (correo_electronico, username, password, area, fecha, accion, pers_modifico, enTabla) 
        VALUES ('" . $correo . "','" . $usuario . "', '" . $contraseña . "', '" . $area . "','" . $date . "','EDICION', '" . $usuario . "', 'MULTIMODAL');
END";
                } else {
                    //do nothing
                }
