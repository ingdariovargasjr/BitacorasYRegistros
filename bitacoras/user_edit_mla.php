...
echo $edicion = "INSERT INTO bitacoras (correo_electronico, username, password, area, fecha, vinculado, accion, pers_modifico, enTabla) 
    VALUES ('" . $correo . "','" . $usuario . "', '" . $contraseña . "', '" . $area . "', '" . $vinculado . "', '" . $fecha . "','EDICIÓN', '" . $user . "', 'MLA')";

echo $sql2 = "SELECT * FROM usuario_mla WHERE id='$edit'";
...
echo "<script>
            ...
            window.location.href='editado_mla.php?edit=$edit&user=$user';
        </script>";
...
echo $edicion = "INSERT INTO bitacoras (correo_electronico, username, password, area, fecha, vinculado, accion, pers_modifico, enTabla) 
    VALUES ('" . $correo . "','" . $usuario . "', '" . $contraseña . "', '" . $area . "', '" . $fecha . "', '" . $vinculado . "','EDICIÓN', '" . $user . "', 'MLA')";
