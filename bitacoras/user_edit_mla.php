...
echo $sql = "UPDATE usuario_mla SET correo_electronico= '$correo ', username= '$usuario', password= '$contraseña', area='$area', vinculado='$vinculado' WHERE id='$edit'";
...
echo "<script>
            ...
            window.location.href='nuevo_registro_mla.php?user=$user';
        </script>"; 
