...
$edit = $_GET['edit'];
$sql = "SELECT * FROM usuario_sodasa WHERE id=$edit";
        ...
        <main class="page registration-page">
            <section class="clean-block clean-form dark">
                <div class="container">
                    ...
                    <form name="sodasaForm" method="post" action="user_edit_sodasa.php?user=<?php echo $user = $_GET['user']; ?>&edit=<?php echo $edit = $_GET['edit']; ?>" onsubmit="return validateForm()" requiered>
                        <div class="form-group"><label for="correo_electronico">Email</label><input class="form-control item" type="text" name="correo_electronico" id="correo_electronico" value="<?php echo $correo ?>">
                        </div>
                        <div class="form-group"><label for="usuario">Usuario</label><input class="form-control item" type="text" name="usuario" id="usuario" value="<?php echo $usuario ?>"></div>
                        <div class="form-group"><label for="contraseña">Contraseña</label><input class="form-control item" type="password" name="contraseña" id="contraseña" value="<?php echo $contraseña ?>"></div>
                        <div class="form-group">
                            <label for="area">Area</label>
                            <input list="encodings" name="area" id="area" class="form-control item col-sm-12 custom-select custom-select-sm" value="<?php echo $area ?>" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input list="vinculacion" name="vinculado" id="vinculado" class="form-control item col-sm-12 custom-select custom-select-sm" value="<?php echo $vinculado ?>">
                        ...
                        <div class="form-group-hidden"><label for="userBit"></label><input class="form-control-hidden" type="hidden" name="userBit" id="userBit" value="<?php echo $edit = $_GET['edit']; ?>">
                            <div class="form-group-hidden"><label for="user"></label><input class="form-control-hidden" type="hidden" name="user" id="user" value="<?php echo $user = $_GET['user']; ?>">
                            </div>
                            <input class="btn btn-outline-success btn-block" name="edicion" id="edicion" type="submit" style="font-family: Montserrat, sans-serif;" value="Actualizar registro">
...
END";
    ...
    <script type="text/javascript">
        function validateForm() {
            var a = document.forms["sodasaForm"]["correo_electronico"].value;
            var b = document.forms["sodasaForm"]["usuario"].value;
            var c = document.forms["sodasaForm"]["contraseña"].value;
            var d = document.forms["sodasaForm"]["area"].value;
            var e = document.forms["sodasaForm"]["vinculado"].value;
            if (a == "" || a == null) {
